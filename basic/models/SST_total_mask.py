...
# from models.CST import SAH_MSA,SAHAB,CST
...
class SSMA(nn.Module):
    ...
    def __init__(self, inp_channels,dim, input_resolution, num_heads, window_size=7, shift_size=0, drop_path=0.0,
        ...
        # self.vapsrCNN = vapsrCNN(dim)
        # self.vapsrCNN2 = vapsrCNN(dim)
        # self.activation = nn.PReLU()
        # self.spatial_attn = SAH_MSA(heads=num_heads, n_rounds=2, channels=dim, patch_size=(16, 16),r=1)
        # self.spatial_attn1 = SAHAB(dim=dim,patch_size=(16,16),heads=num_heads,shift_size=0,sparse=False)
        # self.spatial_attn = CST(dim,2,num_blocks=[2, 2, 2],sparse=True)
...
class SST_total_mask(nn.Module):
    """SST
    ...
    def __init__(self,
        ...
        super(SST_total_mask, self).__init__()

...
from .region import RegionNONLocalBlock
...
class ENCAM(nn.Module):
    def __init__(self ,channels=96,K =24):
        ...
        self.f3d_1 = nn.Conv3d(1, 16, (K, 3, 3), 1, (0, 1, 1))
        self.f3d_2 = nn.Conv3d(1, 16, (K, 7, 7), 1, (0, 3, 3))

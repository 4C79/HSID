...
def local_correlation_softmax_spectral(feature0, feature1, local_radius,
                              padding_mode='zeros',
                              ):
    b, c, h, w = feature0.size()
    # coords_init = coords_grid(b, h, w).to(feature0.device)  # [B, 2, H, W]
    ...
    feature1 =  F.softmax(feature1, 1)

    corr = torch.matmul(feature0_view, feature1).view(b, h * w, -1) / (c ** 0.5)  # [B, H*W, (2R+1)^2]

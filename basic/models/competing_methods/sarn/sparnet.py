...
class SPARNet(nn.Module):
    ...
    def __init__(
        ...
        # ------------ define encoder --------------------
        # self.encoder = []
        # self.encoder.append(ConvLayer(31, n_ch, 3, 1))
        ...
        self.res_layers = []
        self.res_layers.append(ConvLayer(31, n_ch, 3, 1))
        ...
        self.out_conv = ConvLayer(ch_clip(n_ch), 31, 3, 1)
    
    def forward(self, input_img):
        # out = self.encoder(input_img)
        out = self.res_layers(input_img)

...
class StokenAttention(nn.Module):
    def __init__(self, dim, n_iter=1,stoken_size=to_2tuple(8), num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        super().__init__()
...
class SSMA(nn.Module):
    ...
    def __init__(self, inp_channels,dim, input_resolution, num_heads, window_size=7, shift_size=0, drop_path=0.0,
        ...
        self.stoken_attn = StokenAttention(dim,stoken_size=to_2tuple(8),
    ...
    def forward(self, x):
        ...
        x = self.stoken_attn(x)  # global spectral attention
...
class SST_sptoken(nn.Module):
    ...
    def __init__(self,
        ...
        super(SST_sptoken, self).__init__()

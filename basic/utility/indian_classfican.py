...
if __name__ == '__main__':
    ...
    # mat_path = '/data1/jiahua/result/indian_jh/s2s.mat'
    ...
    # print(data.shape)
    # # data = data.transpose((0,2,1))
    # savemat('/data1/jiahua/result/indian/qrnn3d.mat',{'data':data})
    # print(data.shape)
    # for i in range(6):
    #     mat_path = '/data1/jiahua/ly/test_data/india_tmp/'+str(i+1)+'.mat'
    #     result_gt = np.zeros([31,128,128], dtype=np.float64)
    #     result_gt[:,:,:] = data[31*i:31*(i+1),:,:]
    #     savemat(mat_path,{'data':data})
    # result_gt = np.zeros([34,128,128], dtype=np.float64)
    # result_gt[:,:,:] = data[31*6:220,:,:]
    # savemat('/data1/jiahua/ly/test_data/india_tmp/7.mat',{'data':data})

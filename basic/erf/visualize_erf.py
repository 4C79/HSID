...
# --------------------------------------------------------'
# python visualize_erf.py --model scat --weights /home/jiahua/HSID/checkpoints/compare_methods_icvl_complex/scat.pth --data_path /data3/jiahua/ly/test_data/kaist_1024_complex/erf_test/ --save_path /home/jiahua/HSID/basic/erf/erf_model/scat.npy
# python visualize_erf.py --model sert_base --weights /home/jiahua/HSID/checkpoints/compare_methods_icvl_complex/sert_base_complex.pth --data_path /data3/jiahua/ly/test_data/kaist_1024_complex/erf_test/ --save_path /home/jiahua/HSID/basic/erf/erf_model/sert.npy
...
# sys.path.append(os.pardir.pardir)
from utils.dataloader import get_test_data
import models
...
def parse_args():
    ...
    parser.add_argument('--num_images', default=1, type=int, help='num of images to use')
...
def main(args):
    ...
    data_loader_val = get_test_data(args.data_path)
    ...
    for i, (samples, _) in enumerate(data_loader_val):
        if i == args.num_images:
            print("sssssfadf")
            np.save(args.save_path+'sert.npy', meter.avg)
            exit()
